...
console.log(similarity("crocin pain relief tablet 15's", "crocin advance 500mg 20 tablets")); //Remove Strip Of, Bottle Of from the name if it has
app.listen(3001, () => {
